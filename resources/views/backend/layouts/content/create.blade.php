                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body border-0">
                                <form class="form-horizontal" method="post" action="{{ route('admin.content.store') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="type"
                                            ...
                                            <option value="Intermediate"
                                                {{ old('type') == 'Intermediate' ? 'selected' : '' }}>Intermediate</option>
                                            <option value="Advanced" {{ old('type') == 'Advanced' ? 'selected' : '' }}>
                                                Advanced</option>
                                        </select>
                                        @error('type')
                                            <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="row ml-5">
                                        <div class="form-check form-switch ">
                                            <input  type="checkbox" role="" id="is_premium"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="file" name="image"
                                                ...
                                                accept="image/*" data-max-file-size="50M" style="height: 150px;" />
                                            @error('image')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="file" id="video-file-input" name="video"
                                                class="dropify @error('video') is-invalid @enderror" accept="video/*"
                                                style="height: 120px;" />
                                            <div class="d-flex align-items-center mt-2">
                                                <button type="button" id="content-upload-btn"
                                                    class="btn btn-primary btn-sm me-2">Upload Video</button>
                ...
                function uploadNext() {
                    ...
                    $.ajax({
                        ...
                        success: function(resp) {
                            ...
                            $('#content-upload-bar').css('width', progress + '%').text(
                                progress + '%').css({
                                'color': '#fff',
                                'text-align': 'center',
                                'font-size': '12px'
                            ...
                            if (currentChunk < totalChunks) {
                                ...
                                if (resp && resp.path) {
                                    ...
                                    $('#content-upload-btn').prop('disabled', true).text(
                                        'Uploaded');
