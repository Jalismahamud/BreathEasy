    ...
    <div class="app-sidebar" style="overflow: scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('daily-video') ? 'has-link' : '' }}"
                        href="{{ route('admin.daily-video.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            class="side-menu__icon" viewBox="0 0 16 16">
                            <path
                                d="M6.5 3.5A1.5 1.5 0 0 0 5 5v6a1.5 1.5 0 0 0 1.5 1.5h4A1.5 1.5 0 0 0 12 11V5a1.5 1.5 0 0 0-1.5-1.5h-4zM0 5a2 2 0 0 1 2-2h5.5a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5H2a2 2 0 0 1-2-2V5zm14.854.146a.5.5 0 0 1 0 .708L13 7.707V8.293l1.854 1.854a.5.5 0 1 1-.708.708l-2-2a.5.5 0 0 1 0-.708l2-2a.5.5 0 0 1 .708 0z" />
                        </svg>
                        <span class="side-menu__label">Daily Video</span>
                    </a>
                </li>
