...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($existingCategoryCount >= $this->count) {
            return redirect()->route('admin.category.index')->with('error', 'You can only create a maximum of ' . $this->count . ' categories.');
        }
    ...
    public function category()
    {
        try {
            ...
            if (!$category) {
                return $this->success([], 'Category data not found', 200);
            }

            return $this->success($category, 'Category data retrived successfully', 200);
        } catch (Exception $e) {
